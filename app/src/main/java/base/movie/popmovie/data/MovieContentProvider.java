...
import static base.movie.popmovie.data.MovieContract.MovieEntry.TABLE_NAME;
...
public class MovieContentProvider extends ContentProvider {
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        uriMatcher.addURI(MovieContract.AUTHORITY, MovieContract.PATH_MOVIES + "/#", TASK_WITH_ID);
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
     ...
     //   Log.d("URI", String.valueOf(match));
